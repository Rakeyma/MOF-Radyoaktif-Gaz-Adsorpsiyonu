"""DeeperGCN/grafik.py — cd "MOF Radyoaktif Gaz Adsorpsiyonu" && python -m DeeperGCN.grafik"""
...
try:
    ...
    sys.exit("HATA: kok dizinden calistirin: python -m DeeperGCN.grafik")

from DeeperGCN.run_deepergcn import DeeperGCNEncoder, MODEL_ADI, CHECKPOINT_DIR, SONUC_DIR
