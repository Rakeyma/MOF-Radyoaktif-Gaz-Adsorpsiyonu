"""DimeNetPP/grafik.py — cd "MOF Radyoaktif Gaz Adsorpsiyonu" && python -m DimeNetPP.grafik"""
...
try:
    ...
    sys.exit("HATA: kok dizinden calistirin: python -m DimeNetPP.grafik")

from DimeNetPP.run_dimenetpp import DimeNetPPEncoder, MODEL_ADI, CHECKPOINT_DIR, SONUC_DIR
