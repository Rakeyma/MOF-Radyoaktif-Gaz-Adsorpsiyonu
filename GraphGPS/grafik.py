"""GraphGPS/grafik.py — cd "MOF Radyoaktif Gaz Adsorpsiyonu" && python -m GraphGPS.grafik"""
...
try:
    ...
    sys.exit("HATA: kok dizinden calistirin: python -m GraphGPS.grafik")

from GraphGPS.run_graphgps import GraphGPSEncoder, MODEL_ADI, CHECKPOINT_DIR, SONUC_DIR
