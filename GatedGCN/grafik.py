"""GatedGCN/grafik.py — cd "MOF Radyoaktif Gaz Adsorpsiyonu" && python -m GatedGCN.grafik"""
...
try:
    ...
    sys.exit("HATA: kok dizinden calistirin: python -m GatedGCN.grafik")

from GatedGCN.run_gatedgcn import GatedGCNEncoder, MODEL_ADI, CHECKPOINT_DIR, SONUC_DIR
